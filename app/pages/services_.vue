<template>
  <div class="py-16 md:py-10 flex flex-col gap-16 md:gap-12">
    ...
    <PageHeader
      ...
      title="Os Nossos"
      highlight="Serviços"
      subtitle="Clica em qualquer cartão para abrires o visualizador."
    />

    <div class="cw-1">
      <CardGrid :items="pageData.servicesList" />
    </div>
...
// No futuro, isto virá do seu ficheiro JSON do CMS!
const pageData = ref({
  servicesList: [
  {
